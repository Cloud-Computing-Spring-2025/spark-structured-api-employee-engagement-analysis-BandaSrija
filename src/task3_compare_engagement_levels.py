...
def compare_engagement_levels(df):
    ...
    """
    # Group by JobTitle and calculate the average EngagementScore
    result_df = df.groupBy("JobTitle") \
                  .agg(spark_round(avg("EngagementScore"), 2).alias("AvgEngagementLevel")) \
                  .orderBy("AvgEngagementLevel", ascending=False)
...
def main():
    ...
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-BandaSrija/outputs/engagement_levels_job_titles.csv"
